...
CREATE TABLE `tbl_detalle_venta`  (
  `id_detalle_venta` int(0) NOT NULL AUTO_INCREMENT,
  `id_venta` int(0) NOT NULL,
  ...
  CONSTRAINT `tbl_detalle_venta_ibfk_1` FOREIGN KEY (`id_venta`) REFERENCES `tbl_ventas` (`id_venta`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `tbl_detalle_venta` VALUES (3, 16, 21, 2, 600), (4, 17, 22, 4, 4848), (5, 17, 21, 2, 600), (6, 18, 21, 4, 1200), (7, 19, 22, 4, 4848);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tbl_productos` VALUES (21, 1, 'Banano', 1, 'Cajas de bananos', 300.00, 60, 0, 25, '2021-04-15 00:00:00'), (22, 1, 'Prueba a', 1, 'adfsdf', 1212.00, 111, 1, 24, '2021-04-18 00:00:00');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tbl_ventas` VALUES (16, '2021-04-18 00:53:44', 0.00, 1.00, 2, 1), (17, '2021-04-18 00:57:56', 0.00, 2.00, 2, 1), (18, '2021-04-18 01:02:40', 0.00, 1.00, 2, 1), (19, '2021-04-18 01:03:34', 0.00, 1.00, 2, 1);
COMMIT;
